...
var Emisor = (function () {
    ...
    $agent = $("#IsRetentionAgent"),
        ...
        handleLeadingZeros = function handleLeadingZeros() {
        if (changing) {
            return;
        }
        ...
        handleAccounting = function handleAccounting() {
        ...
        handleSpecialContrib = function handleSpecialContrib() {
        ...
        handleSkilledCraftsman = function handleSkilledCraftsman() {
        ...
        initCertificate = function initCertificate() {
        $("#CertificateFile").on("change", handleValidation);
        $("#CertificatePass").on("change", handleValidation);
    },
        add_establishment = function add_establishment() {
        var $obj = $(this);
        ...
        var markup = '<tr id="est_item' + $itemsCount + '" class="establishment-item">' + '<td data-title="Product" style="width:100%">' + '<div class="row">' + '<input id = "estab_Index' + $itemsCount + '"  name = "Establishments.Index" value = "' + $itemsCount + '" type = "hidden" ></input>' + '<div class="col-md-3 col-sm-12 col-xs-12" data-title="Codigo" title="C&oacute;digo establecimiento" style="padding-bottom:5px">' + '<div class="kt-input-icon kt-input-icon--right">' + '<span class="kt-input-icon__icon kt-input-icon__icon--right">' + '<span>' + '<i class="flaticon-home-2"></i>' + '</span>' + '</span>' + '<input id="estab_code' + $itemsCount + '" name="Establishments[' + $itemsCount + '].Code"  class="form-control placeholder-no-fix item-Establishment-Code" type = "number" min = "1" max = "999" minlength = "3" maxlength = "3" placeholder = "Establecimiento" required data-msg = "C&oacute;digo del establecimiento es requerido" />' + '<span class="field-validation-valid text-danger" data-valmsg-for="Establishments[' + $items + '].Code" data-valmsg-replace="true"></span>' + '</div>' + '</div>' + '<div class="col-md-4 col-sm-12 col-xs-12" data-title="Nombre" style="padding-bottom:5px">' + '<div class="col-12 kt-input-icon kt-input-icon--right">' + '<span class="kt-input-icon__icon kt-input-icon__icon--right">' + '<span>' + '<i class="flaticon-profile"></i>' + '</span>' + '</span>' + '<input id="estab_name' + $itemsCount + '" name="Establishments[' + $itemsCount + '].Name" title="Nombre Comercial Establecimiento"  class="form-control item-Establishment-Name"  placeholder = "Nombre comercial" required data-msg = "Nombre comercial del establecimiento es requerido" />' + '<span class="field-validation-valid text-danger" data-valmsg-for="Establishments[' + $itemsCount + '].Name" data-valmsg-replace="true"></span>' + '</div>' + '</div>' + '<div class="col-md-5 col-sm-12 col-xs-12" data-title="Direccion" style="padding-bottom:5px">' + '<div class="kt-input-icon kt-input-icon--right">' + '<span class="kt-input-icon__icon kt-input-icon__icon--right">' + '<span>' + '<i class="flaticon-placeholder-3"></i>' + '</span>' + '</span>' + '<input id="estab_address' + $itemsCount + '" name="Establishments[' + $itemsCount + '].Address" title="Direcci&oacute;n Comercial Establecimiento"  class="form-control item-Establishment-address" placeholder = "Direcci&oacute;n" required data-msg = "La direcci&oacute;n del establecimiento es requerido"/>' + '<span class="field-validation-valid text-danger" data-valmsg-for="Establishments[' + $itemsCount + '].Address" data-valmsg-replace="true"></span>' + '</div>' + '</div>' + '<div class="col-md-12 col-sm-12 col-xs-12">' + '<div class="accordion accordion-solid accordion-toggle-plus" id="accordIssuePointItem' + $itemsCount + '">' + '<div class="card">' + '<div class="card-header" id="itemHeading' + $itemsCount + '">' + '<div class="card-title collapsed" data-toggle="collapse" data-target="#itemsCollapse' + $itemsCount + '" aria-expanded="false" aria-controls="itemsCollapse' + $itemsCount + ')">' + '<br /><i class="flaticon2-add"></i>  Configuraci&oacute;n Puntos de Emisi&oacute;n ' + '</div>' + '</div>' + '<div id="itemsCollapse' + $itemsCount + '" class="collapse" aria-labelledby="itemHeading' + $itemsCount + '" data-parent="#accordIssuePointItem' + $itemsCount + '" style="">' + '<div class="card-body">' + '<table id="issuePoint-items' + $itemsCount + '" data-content="' + $itemsCount + '" class="table kt-datatable__table table-adicional table-hover table-striped table-condensed cf">' + '<thead class="cf card-title kt-datatable__head">' + '<tr class="kt-datatable__row">' + '<th>' + '<div class="row">' + '<div class="col-md-6 col-sm-8 col-xs-10" data-title="Codigo" style="padding-bottom:5px">C&oacute;digo</div>' + '<div class="col-md-2 col-sm-2 col-xs-2" data-title="Eliminar" style="padding-bottom:5px"></div>' + '</div>' + '</th>' + '</tr>' + '</thead>' + '<tbody>' + '<tr id="issuePoint-item' + $itemsCount + '" class="product-item' + $itemsCount + '">' + '<td>' + '<div class="row">' + '<input id = "issuePoint_Index' + $itemsCount + '_' + $items + '"  name = "IssuePoint.Index" value = "' + $itemsCount + '" type = "hidden" ></input>' + '<div class="col-md-6 col-sm-8 col-xs-10" data-title="Codigo" style="padding-bottom:5px">' + '<div class="kt-input-icon kt-input-icon--right">' + '<span class="kt-input-icon__icon kt-input-icon__icon--right">' + '<span>' + '<i class="flaticon-map"></i>' + '</span>' + '</span>' + '<input id="code_' + $itemsCount + '_' + $items + '" name="Establishments[' + $itemsCount + '].IssuePoint[' + $items + '].Code" data-field="' + $itemsCount + '"  class="form-control placeholder-no-fix item-IssuePoint-Code", type = "number" min = "1" max = "999" minlength = "3" maxlength = "3" placeholder = "Punto emisi&oacute;n"  required data-msg = "El punto de emisi&oacute;n es requerido" />' + '<span class="field-validation-valid text-danger" data-valmsg-for="Establishments[' + $itemsCount + '].IssuePoint[' + $items + '].Code" data-valmsg-replace="true"></span>' + '</div>' + '</div>' + '<div class="col-md-2 col-sm-2 col-xs-2" data-title="Eliminar" style="padding-bottom:5px">' + '<button id="add_trash_' + $itemsCount + '_' + $items + '" title="Eliminar Punto emisi&oacute;n" type="button" class="delete-item btn" data-field="issuePoint-items' + $itemsCount + '" style="width:auto;float:none;">' + '<span class="la la-trash-o "></span>' + '</button>' + '</div>' + '</div>' + '</td>' + '<td data-title="">' + '</td>' + '</tr>' + '</tbody>' + '<tfoot>' + '<tr>' + '<td align="left" colspan="2">' + '<div class="row">' + '<div class="col-md-12 col-sm-12 col-xs-12" align="left">' + '<button type="button" id = "add-issuePoint_' + $itemsCount + '_' + $items + '" data-field="issuePoint-items' + $itemsCount + '" title="Agregar puntos de emisi&oacute;n" class="btn btn-brand add-issuePoint btn-sm"><i class="fa fa-plus"></i> P. Emisi&oacute;n</button>' + '</div>' + '</div>' + '</td>' + '</tr>' + '</tfoot>' + '</table>' + '</div>' + '</div>' + '</div>' + '</div>' + '</div>' + '</div>' + '</td>' + '<td data-title="">' + '<button id="estab_add_trash' + $itemsCount + '" title="Eliminar Registro" type="button" class="delete-item btn " style="width:auto;float:none;">' + '<span class="la la-trash-o"></span>' + '</button>' + '</td>' + '</tr>';
        ...
        // eventos de las listas de puntos de emisi�n
        ...
        add_issuePoint = function add_issuePoint() {
        var $obj = $(this);
        ...
        // validar los puntos de emisi�n de cuando el usuario es coperativa de transporte.
        ...
        var markup = '<tr id="issuePoint-item' + $items + '_' + adCount + '" class="product-item' + $items + '"><td><div class="row">' + '<input id = "item' + $items + '_' + adCount + '"  name = "IssuePoint.Index" value = "' + adCount + '" type = "hidden" ></input>' + '<div class="col-md-6 col-sm-8 col-xs-10" data-title="Codigo" style="padding-bottom:5px">' + '<div class="kt-input-icon kt-input-icon--right">' + '<span class="kt-input-icon__icon kt-input-icon__icon--right"><span><i class="flaticon-map"></i></span></span>' + '<input id="code_' + $items + '_' + adCount + '" name="Establishments[' + $items + '].IssuePoint[' + adCount + '].Code" data-field="' + $items + '"  class="form-control placeholder-no-fix item-IssuePoint-Code" type = "number"  min = "1" max = "999" minlength = "3" maxlength = "3" placeholder = "Punto emisi&oacute;n" required data-msg = "El punto de emisi�n es requerido"/>' + '<span class="field-validation-valid text-danger" data-valmsg-for="Establishments[' + $items + '].IssuePoint[' + adCount + '].Code" data-valmsg-replace="true"></span>' + '</div>' + '</div>' + '<div class="col-md-2 col-sm-4 col-xs-6" data-title="Nombre" style="padding-bottom:5px">' + '<button id="add_trash_' + $items + '_' + adCount + '" title="Eliminar Punto emisi&oacute;n" type="button"  class="delete-item btn " style="width:auto;float:none;">' + '<span class="la la-trash-o "></span>' + '</button>' + '</div>' + '</div>' + '</td>' + '<td data-title="">' + '</td>' + '</tr>';
        ...
        delete_issuePoint_item = function delete_issuePoint_item() {
        var $obj = $(this);
            ...
            success: function success(data) {
                ...
                if (data && data.Entity) {
                    ...
                    if (typeof data == 'string' && data.includes("kt-login")) {
                        toastr.error("Su sesi�n ha caducado... por favor vuelva a iniciar sesi�n!");
    ...
    initWizard = function initWizard() {
        ...
        var rucOptions = $isNew ? { required: true, minlength: 13, maxlength: 13, digits: true } : { required: true, digits: true };
        ...
        mensajeError = function mensajeError(data) {
        ...
        validateUserRUC = function validateUserRUC() {
        ...
        newValidation = function newValidation() {
        ...
        validateSubscription = function validateSubscription(obj) {
        var $obj = obj;
        ...
        validateIssuePoint = function validateIssuePoint() {
        var establishment = $("tr.establishment-item");
        for (var i = 0; i < establishment.length; i++) {
            var row = $(establishment[i]);
            var issuePoints = row.find(".item-IssuePoint-Code");
        ...
        vincularEmisor = function vincularEmisor(form) {
        ...
        save_handler = function save_handler() {
