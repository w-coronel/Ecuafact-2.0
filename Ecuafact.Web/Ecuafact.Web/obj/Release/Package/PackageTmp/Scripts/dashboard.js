        ...
        var config = {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    pointHoverBorderColor: Chart.helpers.color(KTApp.getStateColor('warning')).alpha(0.2).rgbString(),
                    data: [
                        10, 20, 16,
                        18, 12, 40,
                        35, 30, 33,
    ...
    var activitiesChart = function() {
        ...
        var config = {
            ...
            data: {
                ...
                datasets: [{
                    label: "Total",
                    backgroundColor: Chart.helpers.color('#00abe5').alpha(1).rgbString(),  //gradient
                    borderColor: '#0076e5',
