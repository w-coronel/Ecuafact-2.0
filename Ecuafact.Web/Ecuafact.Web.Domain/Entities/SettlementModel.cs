...
namespace Ecuafact.Web.Domain.Entities
{
    ...
    public class SettlementModel
    {
        ...
        public SettlementInfo SettlementInfo { get; set; } = new SettlementInfo();

        public List<AdditionalFieldModel> AdditionalFields { get; set; } = new List<AdditionalFieldModel>();
    }

    public class SettlementInfo : InvoiceInfo
    {
